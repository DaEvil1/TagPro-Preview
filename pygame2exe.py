...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Preview.py"
 
        #Name of program
        self.project_name = "TagPro Map Preview"
        ...
        #Auhor of program
        self.author_name = "DaEvil1"
        self.author_email = ""
        self.copyright = "Copyright (c) 2014 DaEvil1."
 
        #Description
        self.project_description = "An app that generates previews of TagPro Maps \
                It needs the png file and json file passed as arguments"
